...
export default function App() {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <section className="relative z-10 px-5 py-16 sm:px-8 sm:py-24">
          <div className="mx-auto max-w-2xl text-center">
            <ScrollReveal>
              ...
              <h2 className="text-4xl font-light text-white sm:text-5xl md:text-6xl" style={{ fontFamily: "var(--font-serif)" }}>
            ...
            <div className="space-y-4 sm:space-y-6">
              {[
                ...
                <ScrollReveal key={i} delay={Math.min(i + 1, 5)}>
                  <p className="text-xl font-light leading-snug text-rose-100/70 sm:text-2xl md:text-3xl" style={{ fontFamily: "var(--font-serif)" }}>
                    {line}
                  </p>
                </ScrollReveal>
              ))}
                ...
                <ScrollReveal key={reason} delay={Math.min((i % 4) + 1, 5)}>
                  <button
                    ...
                    className={`group relative w-full overflow-hidden rounded-xl border p-4 text-left transition-all duration-500 sm:rounded-2xl sm:p-5 ${
                      likedReasons.has(i)
                        ? "border-rose-400/40 bg-rose-500/12 shadow-[0_0_40px_rgba(255,95,143,0.12)]"
                        : "border-white/8 bg-white/[0.03] hover:border-rose-400/20 hover:bg-white/[0.06]"
                    }`}
                  >
                    <span className={`mb-2 inline-block text-lg transition-all duration-300 sm:mb-3 sm:text-xl ${
                      likedReasons.has(i) ? "scale-110" : "grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100"
                    }`}>💕</span>
                    <p className={`text-xs leading-relaxed transition-colors duration-300 sm:text-sm ${
                      likedReasons.has(i) ? "text-rose-100" : "text-rose-200/50"
                    }`}>{reason}</p>
        ...
        <section className="relative z-10 flex min-h-[60vh] flex-col items-center justify-center px-5 py-16 sm:px-8 sm:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <ScrollReveal delay={1}>
              ...
              <p className="mt-6 text-sm text-rose-200/40" style={{ fontFamily: "var(--font-serif)" }}>
                Every second closer to more memories with you.
              </p>
            </ScrollReveal>
          </div>
        </section>
        ...
        <section className="relative z-10 flex min-h-dvh flex-col items-center justify-center px-5 py-16 sm:px-8 sm:py-24">
          <div className="mx-auto max-w-2xl text-center">
            <ScrollReveal>
              <button
                type="button"
                className="gentle-float group relative mx-auto mb-8 block h-40 w-56 cursor-pointer overflow-hidden rounded-2xl border-0 p-0 sm:mb-12 sm:h-52 sm:w-72"
                onClick={openLetter}
                aria-label="Open your love letter"
              >
                <img
                  src="/images/envelope.jpg"
                  alt="A sealed love letter"
                  className="h-full w-full object-cover shadow-[0_20px_80px_rgba(0,0,0,0.5)] transition-transform duration-500 group-hover:scale-105"
                  loading="lazy"
                  draggable={false}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0010]/80 via-[#0a0010]/20 to-transparent" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="rounded-full bg-white/12 px-5 py-2 text-[10px] font-semibold uppercase tracking-[0.25em] text-white/90 backdrop-blur-sm transition-all group-hover:bg-white/22 sm:px-6 sm:py-3 sm:text-xs">
                    Tap to open
                  </span>
                </div>
              </button>
        ...
        <footer className="relative z-10 border-t border-white/5 px-5 py-14 text-center sm:px-8 sm:py-20">
          <ScrollReveal>
            ...
            <p className="mt-5 text-xl text-white/60 sm:mt-6 sm:text-2xl" style={{ fontFamily: "var(--font-serif)" }}>
              Happy 100th day, my love.
            </p>
            <p className="mt-2 text-xs text-rose-200/25 sm:text-sm">
              Here's to the next 100 — and every one after that.
            </p>
      ...
      {/* ─── LETTER MODAL ───────────────────────────────── */}
      <div
        className={`fixed inset-0 z-[80] flex items-center justify-center overflow-y-auto bg-black/75 px-3 py-4 backdrop-blur-2xl transition-all duration-700 sm:px-5 sm:py-8 ${
          letterOpen ? "opacity-100" : "pointer-events-none opacity-0"
        }`}
      ...
      >
        <div
          className={`relative my-auto max-h-[calc(100dvh-2rem)] w-full max-w-2xl overflow-y-auto overflow-x-hidden rounded-2xl border border-white/8 bg-gradient-to-br from-[#1a0a14] via-[#100610] to-[#0a0010] p-5 shadow-[0_40px_140px_rgba(255,95,143,0.12)] transition-all duration-700 sm:max-h-[calc(100dvh-4rem)] sm:rounded-[2rem] sm:p-10 ${
        ...
        >
          ...
          <div className={`relative transition-all duration-1000 ${letterRevealed ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            ...
            <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-rose-400 to-rose-600 shadow-[0_0_40px_rgba(255,95,143,0.25)] sm:mb-8 sm:h-16 sm:w-16">
  ...
  return (
    <div ref={ref} className="mx-auto mt-8 max-w-md sm:mt-12">
      <div className="relative h-6 overflow-hidden rounded-full border border-white/10 bg-white/5 sm:h-8">
        <div
          className="h-full rounded-full bg-gradient-to-r from-rose-500 via-pink-400 to-rose-300 transition-all duration-100"
          style={{ width: `${fill}%` }}
        >
      ...
      {fill >= 100 && (
        <p className="mt-3 text-sm text-rose-300/80" style={{ fontFamily: "var(--font-serif)" }}>
